...
export async function runAskMode() {
  ...
  const question = await text({ message: "What do you went  to ask ?" });
  ...
  //    TODO : web search tool to be exeuted in future
  ...
  const wentsSave = await confirm({
    message: "save this answer in .md file in this current diretory?",
    initialValue: false,
  });

  if (isCancel(wentsSave) || !wentsSave) return;
